...
### How we went from "meh" AI output to something we'd actually put in a design review
...
![The generic-pass diagram — notice the "Integration Gateway" box that merges three different subsystems into one](c4-opencode-generic.svg)
...
![Iteration 1: The generic pass — note the merged "Integration Gateway" and lack of client/cloud boundaries](c4-opencode-generic.svg)
...
![Iteration 2: The protocol pass — better structure, but "Integration Gateway" is still one merged box](c4-opencode-protocol.svg)
...
![Iteration 3: The agentic pass — Provider Runtime, MCP Gateway, and Plugin Runtime are now separate containers](c4-opencode-agentic.svg)
...
![Iteration 5: The final diagram — Share Gateway API added, Automation Client marked as "(inferred)", fallback proxy included](c4-opencode-final.svg)
